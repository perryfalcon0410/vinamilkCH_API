...
public class CommonHealthIndicator implements HealthIndicator {
    ...
    private static String service_name = "common-service";
    ...
    public Health health() {
        try {
            JsonNode resp = restTemplate.getForObject("https://" + urlService.getCommonServiceUrl() + "/actuator/health", JsonNode.class);
