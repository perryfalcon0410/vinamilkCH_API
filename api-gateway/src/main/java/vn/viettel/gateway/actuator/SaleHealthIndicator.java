...
@Component
public class SaleHealthIndicator implements HealthIndicator {

    private static String service_name = "sale-service";
    ...
    public Health health() {
        try {
            JsonNode resp = restTemplate.getForObject("https://" + urlService.getSaleServiceUrl() + "/actuator/health", JsonNode.class);
