...
public class ReportHealthIndicator implements HealthIndicator {
    ...
    private static String service_name = "report-service";
    ...
    public Health health() {
        JsonNode resp = restTemplate.getForObject("https://" + urlService.getReportServiceUrl() + "/actuator/health", JsonNode.class);
