...
public class LogMessage {
    ...
    public final static String EXPORT_EXCEL_CUSTOMER_NOT_TRADE_SUCCESS = "Export excel customer not trade succes";
    ...
    public final static String GET_PROMOTION_PROGRAM_BY_CODE_SUCCESS = "GET_PROMOTION_PROGRAM_BY_CODE_SUCCESS";
