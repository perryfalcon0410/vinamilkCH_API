...
public class InventoryController extends BaseController {
    ...
    public Response<CoverResponse<Page<ImportExportInventoryDTO>, ImportExportInventoryTotalDTO>> getReportInventoryImportExport(
        ...
        InventoryImportExportFilter filter = new InventoryImportExportFilter(this.getShopId(), fromDate, toDate, productIds);

        return inventoryService.getReportInventoryImportExport(filter, pageable);
    }
