...
public class ImportExportInventoryExcel extends ExcelPoiUtils{
    ...
    private void writeHeaderLine()  {
        ...
        ExcelPoiUtils.addCellsAndMerged(sheet,col,++row,colm,++rowm,"Tel: " + (inventoryDTO.getShop().getPhone()!=null? inventoryDTO.getShop().getPhone():"") + " Fax: " + (inventoryDTO.getShop().getFax()!=null?inventoryDTO.getShop().getFax():""),style.get(ExcelPoiUtils.HEADER_LEFT));
        //header right
        if(parentShop != null) {
