...
@Service
public class QuantitySalesReceiptServiceImpl extends BaseReportServiceImpl implements QuantitySalesReceiptService {
    ...
    public TableDynamicDTO callProcedure(QuantitySalesReceiptFilter filter){
        ...
        try{
            ...
            LogFile.logErrorToFile(appName, "[Call Procedure P_CUSTOMER_SALE_ORDER ] " + filter.toString(), ex);
