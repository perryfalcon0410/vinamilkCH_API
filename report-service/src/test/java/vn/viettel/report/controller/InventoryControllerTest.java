...
public class InventoryControllerTest extends BaseTest {
    ...
    public void getReportInventoryImportExport() throws Exception{
        ...
        List<ImportExportInventoryDTO> lstDto = Arrays.asList(new ImportExportInventoryDTO(), new ImportExportInventoryDTO());
        Page<ImportExportInventoryDTO> pageDto = new PageImpl<>(lstDto, pageReq, lstDto.size());
        CoverResponse<Page<ImportExportInventoryDTO>, ImportExportInventoryTotalDTO> response = new CoverResponse<>(pageDto, new ImportExportInventoryTotalDTO());
    ...
    public void getDataPrint() throws Exception{
        ...
        given(inventoryService.getDataPrint(any())).willReturn(new PrintInventoryDTO());
