...
public enum ResponseMessage {
    ...
    ALREADY_EXISTS_EMAIL(1005, "This email already exist"),
    ...
    USER_IMAGE_UPLOAD_FAILED(6050, "image upload failed"),
    USER_IMAGE_DELETE_FAILED(6051, "image delete failed"),
    USER_UPDATE_FAILED(6052, "user update failed"),
    CUSTOMER_NUMBER_DOES_NOT_EXIST(6100, "customer number does not exist"),
    ...
    USER_SUPER_ADMIN_CAN_NOT_DELETE(6162, "user super admin can not delete"),
    CUSTOMER_NOT_EXIST(6163, "Customer does not exist"),
    /**
     * SALON: 7000 -> 7999
     */
    SALON_DOES_NOT_EXIST(7000, "salon does not exist"),
    SALON_ID_MUST_BE_NOT_NULL(7001, "id must be not null"),
    SHOP_SHOPID_MUST_BE_NOT_NULL(7002, "shopId must be not null"),
    SALON_NAME_MUST_BE_NOT_BLANK(7003, "name must be not blank"),
    SALON_NAME_MUST_BE_NOT_NULL(7004, "name must be not null"),
    SHOP_OWNERNAME_MUST_BE_NOT_BLANK(7005, "ownerName must be not blank"),
    SALON_STATUS_MUST_BE_NOT_NULL(7006, "status must be not null"),
