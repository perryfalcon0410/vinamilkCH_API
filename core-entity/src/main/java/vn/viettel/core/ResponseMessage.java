...
public enum ResponseMessage {
    ...
    USER_ROLE_NOT_MATCH(6169, "Tên đăng nhập không có vai trò này"),
    ...
    NO_MORE_STOCK_COUNTING_FOR_TODAY(9014,"Đã có 1 phiếu kiểm kê được tạo trong hôm nay"),
    DATE_RETURN_MUST_NOT_BE_NULL(9015,"DATE_RETURN_MUST_NOT_BE_NULL"),
    SALE_ORDER_NUMBER_MUST_NOT_BE_NULL(9016,"SALE_ORDER_NUMBER_MUST_NOT_BE_NULL"),
    REASON_MUST_NOT_BE_NULL(9017,"REASON_MUST_NOT_BE_NULL"),
    CREATE_USER_MUST_NOT_BE_NULL(9018, "CREATE_USER_MUST_NOT_BE_NULL"),
    PO_CONFIRM_NOT_EXISTS(9019, "PO_CONFIRM_NOT_EXISTS"),
    SALE_ORDER_ALREADY_CREATED(9020, "SALE_ORDER_ALREADY_CREATED"),
    ORDER_RETURN_DOES_NOT_EXISTS(9021, "ORDER_RETURN_DOES_NOT_EXISTS"),
    ORDER_EXPIRED_FOR_RETURN(9022, "ORDER_EXPIRED_FOR_RETURN"),
    /**
