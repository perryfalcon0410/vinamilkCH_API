...
public enum ResponseMessage {
    ...
    PHONE_HAVE_EXISTED(6020, "Your phone have existed"),
    ...
    SALE_ORDER_ID_MUST_NOT_BE_NULL(46005,"SALE_ORDER_ID_MUST_NOT_BE_NULL"),
    SALE_ORDER_NUMBER_MUST_NOT_BE_NULL(46006,"SALE_ORDER_NUMBER_MUST_NOT_BE_NULL"),
    DATE_RETURN_MUST_NOT_BE_NULL(46007,"DATE_RETURN_MUST_NOT_BE_NULL"),
    REASON_MUST_NOT_BE_NULL(46008,"REASON_MUST_NOT_BE_NULL"),
    ORDER_RETURN_DOES_NOT_EXISTS(46009,"ORDER_RETURN_DOES_NOT_EXISTS"),
